...
public class PenyimpananData {
    ...
    private static ArrayList<com.SistemManajemenPerpustakaan.MVC.Models.Peminjaman> dataPeminjaman = new ArrayList<>();

    //GETTER
    public static ArrayList<Pengguna> getPengguna(){ return dataPengguna; }
    public static ArrayList<Buku> getBuku(){ return dataBuku; }
    public static ArrayList<com.SistemManajemenPerpustakaan.MVC.Models.Peminjaman> getDataPeminjaman(){ return dataPeminjaman; }
    ...
    public void setDataPeminjaman(ArrayList<com.SistemManajemenPerpustakaan.MVC.Models.Peminjaman> peminjaman) { this.dataPeminjaman = peminjaman; }
