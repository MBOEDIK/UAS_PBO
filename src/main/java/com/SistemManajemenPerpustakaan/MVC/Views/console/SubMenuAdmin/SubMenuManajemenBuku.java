...
public class SubMenuManajemenBuku implements PersingkatPanggilData {
        ...
        loop : while (true){
            ...
            */
            ...
            for (int i = 0; i < dataBuku.size(); i++){
                System.out.print("\n      "+(i + 1)+". "+dataBuku.get(i).getJudulBuku());
            }
            ...
            */
            ...
            switch (dataBuku.get(inputInt).getKategoriBuku().toLowerCase()){
                case "jurnal ilmiah":
                    System.out.print("" +
                            "\n      6. Institusi" +
                            "\n      7. Terindeks Sinta");
            ...
            /*
            * Meminta input edit isi attribute berdasarkan pilihan attribute sebelumnya
            * */
            switch (subInputInt){
    ...
    public static void menuHapusBuku(){
        loop : while (true){
            ...
            * */
            System.out.print("Kamu yakin ingin menghapus buku \""+dataBuku.get(inputInt).getJudulBuku()+"\"? (y/n): "); inputStr = input.nextLine();
            switch (inputStr.toLowerCase()){
                case "y":
    ...
    public static void menuDetailBuku(){
        loop : while (true){
            ...
            * */
            System.out.print("" +
                    "      1. Kode Buku: "+dataBuku.get(inputInt).getKodeBuku()+"" +
                    "\n      2. Judul: "+dataBuku.get(inputInt).getJudulBuku()+"" +
                    "\n      3. Kategori: "+dataBuku.get(inputInt).getKategoriBuku()+"" +
                    "\n      4. Pengarang: "+dataBuku.get(inputInt).getPengarangBuku()+"" +
                    "\n      5. Tahun Terbit: "+dataBuku.get(inputInt).getTahunTerbitBuku()+"");
            String ketersediaanBuku;
            if (dataBuku.get(inputInt).getKetersediaanBuku()){
            ...
            switch (dataBuku.get(inputInt).getKategoriBuku().toLowerCase()){
                case "jurnal ilmiah":
                    JurnalIlmiah jurnalIlmiah = (JurnalIlmiah) dataBuku.get(inputInt);
                    System.out.print("" +
